# Generated by Django 2.2.1 on 2019-05-10 04:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shape_length', models.DecimalField(decimal_places=8, help_text='Perimeter of polygon', max_digits=15, null=True)),
                ('shape_area', models.DecimalField(decimal_places=15, help_text='Area of polygon', max_digits=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('planner_id', models.CharField(help_text='ID of planner as provided in original data. Looks like a user login id', max_length=100)),
        ...
        migrations.CreateModel(
            name='RecordType',
            fields=[
                ('category', models.CharField(help_text='3-letter acronym for the record type (e.g. PRJ, PRL, ENV).  There are 63 types.', max_length=100, primary_key=True, serialize=False)),
                ('name', models.CharField(help_text='Expansion of the 3-letter acronym (e.g. PRJ, PRL, ENV). There are 63 types.', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.IntegerField(help_text='Esri ArcGIS system ID', null=True)),
                ...
                ('construct_cost', models.FloatField(help_text='Estimated construction cost in dollars of the project', null=True)),
                ...
                ('date_opened', models.DateField(null=True, verbose_name='Date record was opened')),
                ('date_closed', models.DateField(null=True, verbose_name='Date record was closed')),
                ('related_building_permit', models.CharField(help_text='Related Building Permit Number', max_length=100)),
                ('bos_1st_read', models.DateField(help_text='Full Board Hearing Date, First', null=True)),
                ('bos_2nd_read', models.DateField(help_text='Full Board Hearing Date, Second', null=True)),
                ('com_hearing', models.DateField(help_text='Committee Hearing Date', null=True)),
                ('mayoral_sign', models.DateField(help_text='Mayoral Action - Ordinance Signed Date', null=True)),
                ('transmit_date_bos', models.DateField(help_text='Materials Hearing to BOS Clerk Date', null=True)),
                ('com_hearing_date_bos', models.DateField(help_text='Committee Hearing Date - BOS Review', null=True)),
                ('environmental_review', models.ForeignKey(help_text='Environmental Review type', null=True, on_delete=django.db.models.deletion.SET_NULL, to='ppts.EnvironmentalReview')),
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ppts.Location')),
                ('mcd_referral', models.ForeignKey(help_text='Medical Cannabis Dispensary referral', null=True, on_delete=django.db.models.deletion.SET_NULL, to='ppts.MCDReferral')),
                ...
                ('record_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ppts.RecordType')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectFeature',
            fields=[
                ...
                ('exist', models.DecimalField(decimal_places=2, help_text='Existing amount', max_digits=15, null=True)),
                ('proposed', models.DecimalField(decimal_places=2, help_text='Proposed amount', max_digits=15, null=True)),
                ('net', models.DecimalField(decimal_places=2, help_text='Net change', max_digits=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposed', models.DecimalField(decimal_places=2, help_text='Proposed amount', max_digits=15, null=True)),
                ('net', models.DecimalField(decimal_places=2, help_text='Net change', max_digits=15, null=True)),
                ('area', models.DecimalField(blank=True, decimal_places=2, help_text='Area (optional)', max_digits=15, null=True)),
                ('record', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ppts.Record')),
            ],
        ),
    ]
